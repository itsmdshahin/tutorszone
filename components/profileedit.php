...
<body>
    ...
    <div class=''>
        ...
        <form action='profileAction.php' method='post' enctype='multipart/form-data'>
            ...
            <!-- <div class="md-3 lg-6 sm-12">
                ...
                <input type="file" id="u_certi" name="u_certi" value="<?php echo $row['CERTIFICATE'] ?>">
                <br>
            </div>
            <div class="md-3 lg-6 sm-12">
                <label>Show preview: </label>
                <img id="u_CERTIFICATE" width="100px" src="<?php echo $row['CERTIFICATE'] ?>" alt="Photo">
                <br>
            </div> -->
    ...
    <script>
        $(document).ready(function() {
            $('#u_certi').change(function() {
                var reader = new FileReader();
                reader.onload = function(e) {
                    $('#u_CERTIFICATE').attr('src', e.target.result);
                }
                reader.readAsDataURL(this.files[0]);
            });
        });
